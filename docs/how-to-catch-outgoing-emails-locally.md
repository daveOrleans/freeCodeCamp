...
Once you have installed MailHog and started it running you need to open your MailHog inbox in your browser. Open a new browser tab or window and navigate to [http://localhost:8025](http://localhost:8025).
