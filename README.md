...
If you think you've found a bug, first read the [Help I've Found a Bug](https://www.freecodecamp.org/forum/t/how-to-report-a-bug/19543) article and follow its instructions. If you're confident it's a new bug, and have confirmed that someone else facing the same issue, go ahead and create a new [GitHub issue](https://github.com/daveOrleans/freeCodeCamp/blob/master/.github/ISSUE_TEMPLATE/bug-report--software-issue-in-learning-platform.md). Be sure to include as much information as possible so we can reproduce the bug.
